 ...
 */
extern void SH_SendChar(int ch); //Send a byte via the semihost channel
extern void SH_SendString(const char *str); // Send a string via the semihost channel
extern char SH_GetChar(); //Get a byte via the semihost channel

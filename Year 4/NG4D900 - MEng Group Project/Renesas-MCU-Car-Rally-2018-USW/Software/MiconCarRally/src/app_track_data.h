...
track_t track = {
	...
	.pattern_map = {
		...
		{b01000000,  10, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b10000000,  10, 100, 100, 5, 0.1, 100000, MODE_AVOID_LEFT_BOUNDARY },
		{b00000001,  10, 100, 100, 5, 0.1, 100000, MODE_AVOID_RIGHT_BOUNDARY},
		{b00000010, -10, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00000100, -7,  100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00011100, -5,  100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00001100, -7,  100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00001110, -10, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00000110, -15, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00000111, -25, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00000011, -30, 100, 100, 5, 0.1, 100000, MODE_AVOID_RIGHT_BOUNDARY},
		{b00111000,  5,  100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b00110000,  7,  100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b01110000,  10, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b01100000,  15, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b11100000,  25, 100, 100, 5, 0.1, 100000, MODE_FOLLOW_NORMAL_TRACE },
		{b11000000,  30, 100, 100, 5, 0.1, 100000, MODE_AVOID_LEFT_BOUNDARY }
	},

...
\lstinputlisting[caption=MATLAB function for calculating the call blocking probability on a telephone exchange system - ErlangB.m]{\programs{ErlangB.m}}
...
$desired\_grade\_of\_service$ value to 0.1\% the result becomes:

...
/* RDKRX63N */
/** NOTE: For some reason, the "new" FIT BSP driver does not include mcu_info.h inside, which some FIT modules depend on.
 * Inside this missing header, these two definitions would be found: **/
#define MCU_RX63N        (1)
#define PACKAGE_LQFP100  (1)
/** END OF NOTE **/
#include <drivers/onchip/r_bsp/board/rdkrx63n/r_bsp.h>
